...
Breadcrumbs::for('departments', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.departments'), route('office.departments.index'));
});
...
Breadcrumbs::for('designations', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.designations'), route('office.designation.index'));
});
...
Breadcrumbs::for('pre-registers', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.pre-registers'), route('office.pre-registers.index'));
});
...
Breadcrumbs::for('visitors', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.visitors'), route('office.visitors.index'));
});
...
Breadcrumbs::for('administrators', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.administrators'), route('office.user.index'));
});
...
Breadcrumbs::for('roles', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.roles'), route('office.role.index'));
});
...
Breadcrumbs::for('language', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.language'), route('office.language.index'));
});
...
Breadcrumbs::for('addons', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.addons'), route('office.addons.index'));
});
