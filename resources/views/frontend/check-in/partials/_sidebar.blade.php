                    ...
                    <h4 class="font-bold mb-6 text-lg-center">
                        <a href="/" class="d-none d-xl-block mb-6">
                            @if (setting('site_logo'))
                                <img src="{{ asset(setting('site_logo')) }}" class="mx-auto fill-primary"
                                    data-inject-svg="" alt="" style="height: 46px;">
                            @else
                                <img src="{{ asset('assets/images/brand.png') }}" class="mx-auto fill-primary"
                                    data-inject-svg="" alt="" style="height: 46px;">
                            @endif
                        </a>
                        {{ setting('site_name') }}
