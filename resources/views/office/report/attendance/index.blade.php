...
@section('main-content')
    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <form action="<?= route('office.attendance-report.post') ?>" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                ...
                                <button class="btn btn-primary form-control"
                                    type="submit">{{ __('attendance_report.get_report') }}</button>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-success btn-sm report-print-button"
                            onclick="printDiv('printablediv')">{{ __('attendance_report.print') }}</button>
                    </div>
                                    ...
                                    <thead>
                                        ...
                                        @foreach ($attendances as $attendance)
                                            <tr>
                                                <td>{{ $i += 1 }}</td>
                                                <td>
                                                    <figure class="avatar mr-2"><img src="{{ $attendance->user->images }}"
                                                            alt=""></figure>
                                                </td>
