...
@section('main-content')
    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <form action="<?= route('office.admin-visitor-report.post') ?>" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                ...
                                <button class="btn btn-primary form-control"
                                    type="submit">{{ __('visitor_report.get_report') }}</button>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-success btn-sm report-print-button"
                            onclick="printDiv('printablediv')">{{ __('visitor_report.print') }}</button>
                    </div>
                                    ...
                                    <thead>
                                        ...
                                        @foreach ($visitors as $visitor)
                                            <tr>
                                                <td>{{ $i += 1 }}</td>
                                                <td>
                                                    <figure class="avatar mr-2"><img src="{{ $visitor->images }}"
                                                            alt=""></figure>
                                                </td>
