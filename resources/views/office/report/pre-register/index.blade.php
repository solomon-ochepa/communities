...
@section('main-content')
    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <form action="<?= route('office.admin-pre-registers-report.post') ?>" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="from_date"
                                        class="form-control @error('from_date') is-invalid @enderror datepicker"
                                        value="{{ old('from_date', $set_from_date) }}">
                                    @error('from_date')
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="to_date"
                                        class="form-control @error('to_date') is-invalid @enderror datepicker"
                                        value="{{ old('to_date', $set_to_date) }}">
                                    @error('to_date')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <button class="btn btn-primary form-control"
                                    type="submit">{{ __('pre_register_report.get_report') }}</button>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-success btn-sm report-print-button"
                            onclick="printDiv('printablediv')">{{ __('Print') }}</button>
                    </div>
                                        ...
                                        @foreach ($preRegisters as $preRegister)
                                            <tr>
                                                ...
                                                @if (optional($preRegister->visitor)->is_pre_register == 1)
                                                    <td>
                                                        <p class="text-danger">{{ $preRegister->expected_date }}</p>
                                                    </td>
                                                    <td>
                                                        <p class="text-danger">{{ $preRegister->expected_time }}</p>
                                                    </td>
                                                @else
                                                    <td>
