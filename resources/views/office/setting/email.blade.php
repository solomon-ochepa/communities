...
@section('admin.setting.layout')
    <div class="col-md-9">
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('office.setting.email-update') }}">
                    @csrf
                    <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('email_setting.email_setting') }}</legend>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="mail_host">{{ __('email_setting.mail_host') }}</label> <span
                                ...
                                <div class="form-group">
                                    <label for="mail_username">{{ __('email_setting.mail_username') }}</label> <span
                                        class="text-danger">*</span>
                                ...
                                <div class="form-group">
                                    <label for="mail_from_name">{{ __('email_setting.mail_from_name') }}</label> <span
                                        class="text-danger">*</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="mail_disabled" id="mail_disabled"
                                        ...
                                        <option value="1"
                                            {{ old('mail_disabled', setting('mail_disabled')) == 1 ? 'selected' : '' }}>
                                            {{ __('email_setting.enable') }}</option>
                                        <option value="0"
                                            {{ old('mail_disabled', setting('mail_disabled')) == 0 ? 'selected' : '' }}>
                                            {{ __('email_setting.disable') }}</option>
                                    </select>
                                    @error('mail_disabled')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="mail_port">{{ __('email_setting.mail_port') }}</label> <span
                                        class="text-danger">*</span>
                                ...
                                <div class="form-group">
                                    <label for="mail_password">{{ __('email_setting.mail_password') }}</label> <span
                                        class="text-danger">*</span>
                                ...
                                <div class="form-group">
                                    <label for="mail_from_address">{{ __('email_setting.mail_from_address') }}</label>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <button type="submit" class="btn btn-primary">
                                <span>{{ __('email_setting.update_email_setting') }}</span>
                            </button>
                        </div>
                    </div>
                </form>
