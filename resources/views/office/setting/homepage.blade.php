                    ...
                    <fieldset class="setting-fieldset">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group" id="">
                                    <label class="control-label"
                                        for="defaultUnchecked">{{ __('frontend_setting.photo_capture_enable_disable') }}</label>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="photo_capture_enable"
                                                {{ setting('photo_capture_enable') == true ? 'checked' : '' }}
                                                value="1">{{ __('frontend_setting.enable') }}
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="photo_capture_enable"
                                                {{ setting('photo_capture_enable') == false ? 'checked' : '' }}
                                                value="0">{{ __('frontend_setting.disable') }}
                                        </label>
                                    </div>
                                </div>
