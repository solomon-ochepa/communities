        ...
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal" role="form" method="POST"
                    action="{{ route('office.setting.site-update') }}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    @if (setting('site_logo'))
                                        <img class="img-thumbnail image-width mt-4 mb-3" id="previewImage"
                                            src="{{ asset(setting('site_logo')) }}" alt="{{ __('visitor pass Logo') }}" />
                                    @else
                                        <img class="img-thumbnail image-width mt-4 mb-3" id="previewImage"
                                            src="{{ asset('logo.png') }}" alt="{{ __('Visitor pass Logo') }}" />
                                    @endif
                                </div>
