                    ...
                    <div class="card">
                        ...
                        <div class="profile-widget-description profile-widget-employee">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8">{{ isset($employee->department) ? $employee->department->name : '' }}
                                </dd>
                                <dt class="col-sm-4">{{ __('employee.designation') }}</dt>
                                <dd class="col-sm-8">
                                    {{ isset($employee->designation) ? $employee->designation->name : '' }}</dd>
                ...
                <div class="col-12 col-md-12 col-lg-8">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-visitor-tab" data-toggle="tab" href="#nav-visitor"
                                role="tab" aria-controls="nav-visitor"
                            ...
                            <a class="nav-item nav-link" id="nav-register-tab" data-toggle="tab" href="#nav-register"
                                ...
                                aria-selected="false">{{ __('employee.pre_registers') }}</a>
                        </div>
                    </nav>
