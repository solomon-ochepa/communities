                    ...
                    <div class="card">
                        ...
                        @can('employee.create')
                            <div class="card-header">
                                <a href="{{ route('office.employees.create') }}" class="btn btn-icon icon-left btn-primary"><i
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover" id="maintable"
                                    data-url="{{ route('office.employees.get-employees') }}"
                                    data-status="{{ \App\Enums\Status::ACTIVE }}"
                                    data-hidecolumn="{{ auth()->user()->can('employee.show') ||auth()->user()->can('employee.edit') ||auth()->user()->can('employee.delete') }}">
                                    <thead>
                                        <tr>
                                            <th>{{ __('levels.id') }}</th>
