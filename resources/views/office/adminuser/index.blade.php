                    ...
                    <div class="card">
                        @can('user.create')
                            <div class="card-header">
                                <a href="{{ route('office.user.create') }}" class="btn btn-icon icon-left btn-primary"><i
                                        class="fas fa-plus"></i> {{ __('administrator.add_administrator') }}</a>
                            </div>
                        @endcan
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover" id="maintable" data-url="{{ route('office.user.get') }}"
