        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form action="{{ route('office.pre-registers.update', $preregister) }}" method="POST"
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <input id="first_name" type="text" name="first_name"
                                            ...
                                            value="{{ old('first_name', $preregister->visitor->first_name) }}">
                                        @error('first_name')
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input id="last_name" type="text" name="last_name"
                                            ...
                                            value="{{ old('last_name', $preregister->visitor->last_name) }}">
                                        @error('last_name')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label>{{ __('pre_register.email_address') }}</label> <span
                                            class="text-danger">*</span>
                                        <input type="text" name="email"
                                            class="form-control @error('email') is-invalid @enderror"
                                            value="{{ old('email', $preregister->visitor->email) }}">
                                        @error('email')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input type="text" name="phone"
                                            ...
                                            value="{{ old('phone', $preregister->visitor->phone) }}">
                                        @error('phone')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col">
                                        <label>{{ __('visitor.national_identification_no') }}</label> <span
                                            class="text-danger">*</span>
                                        <input type="text" name="national_identification_no"
                                            class="form-control @error('national_identification_no') is-invalid @enderror"
                                            value="{{ old('national_identification_no', $preregister->visitor->national_identification_no) }}">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <select id="gender" name="gender"
                                            ...
                                            @foreach (trans('genders') as $key => $gender)
                                                <option value="{{ $key }}"
                                                    {{ old('gender', $preregister->visitor->gender) == $key ? 'selected' : '' }}>
                                                    {{ $gender }}</option>
                                            @endforeach
                                        </select>
                                        @error('gender')
                                        ...
                                        <select id="employee_id" name="employee_id"
                                            ...
                                            @foreach ($employees as $key => $employee)
                                                <option value="{{ $employee->id }}"
                                                    {{ old('employee_id', $preregister->employee_id) == $employee->id ? 'selected' : '' }}>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" autocomplete="off" id="date-picker" name="expected_date"
                                            ...
                                            value="{{ old('expected_date', $preregister->expected_date) }}">
                                        @error('expected_date')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
