        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form action="{{ route('office.visitors.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="first_name">{{ __('visitor.first_name') }}</label> <span
                                    ...
                                    <div class="form-group col">
                                        <label for="last_name">{{ __('visitor.last_name') }}</label> <span
                                            class="text-danger">*</span>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label>{{ __('visitor.phone') }}</label> <span class="text-danger">*</span><span
                                            class="text-info"> (With Country Code,Without + sign)</span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="gender">{{ __('visitor.gender') }}</label> <span
                                            class="text-danger">*</span>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label for="employee_id">{{ __('visitor.select_employee') }}</label> <span
                                            class="text-danger">*</span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="purpose">{{ __('visitor.purpose') }}</label> <span
                                            class="text-danger">*</span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-6">
                                        <label for="customFile">{{ __('visitor.image') }}</label><span
                                            class="text-danger"> *</span>
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label"
                                                for="customFile">{{ __('visitor.choose_file') }}</label>
                                        </div>
                                        @if ($errors->has('image'))
