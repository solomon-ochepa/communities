...
class EmployeConfirmation extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->markdown('office.mail.visitor.employee', ['visitor' => $visitor]);
    }
    ...
    {
        $email = $this->visitingDetails->visitor->email ? (' Email: ' . $this->visitingDetails->visitor->email) : null;
        return (new TwilioSmsMessage())
            ->content(strip_tags(setting('notify_templates'))  . ' Visitor Name: ' . $this->visitingDetails->visitor->name . '.' . $email . '.' . ' Phone: ' . $this->visitingDetails->visitor->phone);
    }
    /**
