...
class SendInvitationToVisitors extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line('Your QrCode Link here: ')
            ->line(route('qrcode',$this->pre_register->visitor->phone))
    ...
    public function toTwilio($notifiable)
    {
        return (new TwilioSmsMessage())
            ->content(setting('invite_templates') .'Invited To '.$this->pre_register->employee->name. 'Visitor Name: '. $this->pre_register->visitor->name . ' Email: ' .$this->pre_register->visitor->email .' Phone: ' .$this->pre_register->visitor->phone . '<--------->'.'Thank you for using our application! '.setting('site_name'));
    }
    /**
