...
class BookingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('office.booking.index', compact('bookings', 'booking'));
    }
    ...
    public function create(Request $request)
    {
        if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('reception')) {
            ...
            return view('office.booking.create', compact('bookings', 'employees', 'employee', 'departments'));
        } else {
            $employee = Employee::find(auth()->id());
            $request->session()->put('employee', $employee);
            return redirect()->route('office.bookings.step-two');
        }
    }
    ...
    public function createStepTwo(Request $request)
    {
        ...
        return view('office.booking.create-step-two', compact('bookings', 'employee'));
    }
    ...
    public function postCreateStepTwo(Request $request)
    {
        ...
        return redirect()->route('office.bookings.step-three');
    }
    ...
    public function createStepThree(Request $request)
    {
        ...
        return view('office.booking.create-step-three', compact('visitor', 'bookings', 'employee'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($visitor) {
            ...
            if ($booking) {
                ...
                return redirect()->route('office.bookings.index')->with('success', 'booking  successfully');
            }
        }
    }
