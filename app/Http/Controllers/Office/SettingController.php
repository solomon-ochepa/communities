...
class SettingController extends BackendController
{
    ...
    public function index()
    {
        ...
        return view('office.setting.site', $this->data);
    }
    ...
    public function siteSettingUpdate(Request $request)
    {
        ...
        return redirect(route('office.setting.index'))->withSuccess('The Site setting updated successfully');
    }

    // SMS Setting
    public function smsSetting()
    {
        return view('office.setting.sms');
    }
    ...
    public function smsSettingUpdate(Request $request)
    {
        ...
        return redirect(route('office.setting.sms'))->withSuccess('The SMS setting updated successfully.');
    }
    // FCM Setting
    public function fcmSetting()
    {
        return view('office.setting.fcm-notification');
    }
    ...
    public function fcmSettingUpdate(Request $request)
    {
        ...
        Setting::save();
        return redirect(route('office.setting.fcm'))->withSuccess('The Firebase Notification setting updated successfully.');
    }

    // email template Setting
    public function emailTemplateSetting()
    {
        return view('office.setting.email-template');
    }
    ...
    public function mailTemplateSettingUpdate(Request $request)
    {
        ...
        Setting::set($settingArray);
        Setting::save();
        return redirect(route('office.setting.email-template'))->withSuccess('The Email & Sms template setting updated successfully.');
    }

    // EMail Setting
    public function emailSetting()
    {
        return view('office.setting.email');
    }
    ...
    public function emailSettingUpdate(Request $request)
    {
        ...
        return redirect(route('office.setting.email'))->withSuccess('The Email setting updated successfully');
    }
    // Notification Setting
    public function notificationSetting()
    {
        return view('office.setting.notification');
    }
    ...
    public function notificationSettingUpdate(Request $request)
    {
        ...
        return redirect(route('office.setting.notification'))->withSuccess('The Notification setting updated successfully.');
    }

    // Homepage Setting
    public function homepageSetting()
    {
        return view('office.setting.homepage');
    }
    ...
    public function homepageSettingUpdate(Request $request)
    {
        ...
        return redirect(route('office.setting.homepage'))->withSuccess('The Home page setting updated successfully');
    }
    ...
    {
        return view('office.setting.whatsapp');
    }
    ...
    public function whatsappSettingupdate(Request $request)
    {
        ...
        return redirect(route('office.setting.whatsapp-message'))->withSuccess('The Notification setting updated successfully.');
    }
}
