...
if (! function_exists('status')) {
     ...
     */
    function status(int|string|array|null $code = null, $default = null): int|string|array|null
    {
...
if (! function_exists('user')) {
     ...
     */
    function user(array|int|string|null $id = null)
    {
        if (is_array($id)) {
...
if (! function_exists('number_format_k')) {
    ...
    function number_format_k(float $number): string
    {
        ...
        if ($number >= $b = 1000000000) {
            ...
            return "{$number}b";
        } elseif ($number >= $m = 1000000) {
            $number = number_format($number / $m, 2);

            return "{$number}m";
        } elseif ($number >= $k = 1000) {
