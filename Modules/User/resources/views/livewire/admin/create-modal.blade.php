                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="user[first_name]"
                                            ...
                                            placeholder="{{ __('First Name') }}" wire:model="user.first_name" required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="user[last_name]"
                                            ...
                                            placeholder="{{ __('Last Name') }}" wire:model="user.last_name" required>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <input type="tel" name="user[username]"
                                            ...
                                            placeholder="{{ __('Username') }}" wire:model="user.username" required>
                                    </div>
                                    @error('user.username')
                                        <div class="form-text text-danger">{{ __($message) }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <input type="tel" name="user[phone]"
                                            ...
                                            placeholder="{{ __('Phone') }}" wire:model="user.phone" required>
                                    </div>
                                    @error('user.phone')
                                        <div class="form-text text-danger">{{ __($message) }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="user[email]"
                                            ...
                                            placeholder="{{ __('Email') }}" wire:model="user.email" required>
                                    </div>
                                    @error('user.email')
                                        <div class="form-text text-danger">{{ __($message) }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="password" name="user[password]"
                                            ...
                                            value="{{ old('user.password') }}" aria-label="{{ __('Password') }}"
                                            placeholder="{{ __('Password') }}" wire:model="user.password" required>
                                    </div>
                                    @error('user.password')
                                        <div class="form-text text-danger">{{ __($message) }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <textarea name="user[address]" class="form-control small-textarea-height" id="user-address" placeholder="Address"
                                            _rows="1" wire:model="user.address">{{ old('user.address') }}</textarea>
                                        @error('user.address')
