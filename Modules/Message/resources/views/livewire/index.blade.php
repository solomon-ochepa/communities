        ...
        <div class="chat-box-inner">
            <div class="chat-meta-user">
                <div class="current-chat-user-name">
                    <span class="d-flex">
                        <img src="/unknown.svg" alt="dynamic-image">
                        <span class="name strong fw-bold"></span>
                    </span>
                </div>
                ...
                <div class="chat-action-btn align-self-center">
                    {{-- <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        stroke-linejoin="round" class="feather feather-phone  phone-call-screen">
                        <path
                ...
                <div id="chat-conversation-box-scroll" class="chat-conversation-box-scroll">
                    @foreach ($conversations ?? [] as $key => $conversation)
                        ...
                        @empty
                            <div class="chat" data-chat="person{{ $user->id }}">
                                <div class="conversation-start">
                                    <span>{{ @now()->calendar() }}</span>
                                    <span class="d-block d-flex flex mt-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
